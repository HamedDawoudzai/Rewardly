...
const CreateUserPage = () => {
  ...
  const getRoleStyles = (role) => {
    const styles = {
      regular: "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600",
      cashier: "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border-blue-300 dark:border-blue-700",
      manager: "bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border-purple-300 dark:border-purple-700",
      superuser: "bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 border-red-300 dark:border-red-700",
    };
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              ...
              <span className="font-medium text-gray-900 dark:text-white">{createdUser.name || form.name}</span> has been
              created.
            </p>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6 text-left">
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  <span className="text-gray-500 dark:text-gray-400">UTORid:</span>
                ...
                <div className="col-span-2">
                  ...
                  <span className="ml-2 text-gray-900 dark:text-white">{createdUser.email || form.email}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-rewardly-blue focus:border-transparent transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
